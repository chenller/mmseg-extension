...
@OPTIM_WRAPPER_CONSTRUCTORS.register_module(name='ext-LayerDecayOptimizerConstructorViTAdapter')
class LayerDecayOptimizerConstructorViTAdapter(DefaultOptimWrapperConstructor):
