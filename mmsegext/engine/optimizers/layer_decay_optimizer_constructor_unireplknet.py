...
@OPTIM_WRAPPER_CONSTRUCTORS.register_module(name='ext-UniRepLKNetLearningRateDecayOptimizerConstructor')
class UniRepLKNetLearningRateDecayOptimizerConstructor(DefaultOptimWrapperConstructor):
