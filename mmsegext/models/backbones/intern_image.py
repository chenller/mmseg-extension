...
#
#         print_log(f'using core type: {core_op}', logger='current', level=logging.INFO)
#         print_log(f'using activation layer: {act_layer}', logger='current', level=logging.INFO)
#         print_log(f'using main norm layer: {norm_layer}', logger='current', level=logging.INFO)
#         print_log(f'using dpr: {drop_path_type}, {drop_path_rate}', logger='current', level=logging.INFO)
#         print_log(f"level2_post_norm: {level2_post_norm}", logger='current', level=logging.INFO)
#         print_log(f"level2_post_norm_block_ids: {level2_post_norm_block_ids}", logger='current', level=logging.INFO)
#         print_log(f"res_post_norm: {res_post_norm}", logger='current', level=logging.INFO)
#         print_log(f"use_dcn_v4_op: {use_dcn_v4_op}", logger='current', level=logging.INFO)
#
#         in_chans = 3
...
#             print_log(meg, logger='current', level=logging.INFO)
#
