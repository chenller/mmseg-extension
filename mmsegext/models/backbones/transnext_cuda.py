...
try:
    ...
    warnings.warn('\'mmsegextlib_swattention\' package not found, loading PyTorch native version of TransNeXt. ')
    from .transnext_native import *
...
@BACKBONES.register_module(name='ext-TransNeXt')
...
@BACKBONES.register_module(name='ext-TransNeXt-tiny')
...
@BACKBONES.register_module(name='ext-TransNeXt-small')
...
@BACKBONES.register_module(name='ext-TransNeXt-base')
